...
function optionsframework_options() {
	...
	$imagepath =  get_bloginfo('template_directory') . '/img/';
	...
	$options[] = array(
		'name' => __('Example Custom typography', 'options_framework_theme'),
		'desc' => __('Options of Custom typography.', 'options_framework_theme'),
	...
	$options[] = array(
		...
		'desc' => __('No hay un color por defecto seleccionado.', 'options_framework_theme'),
		'id' => 'example_colorpicker',
		'std' => '',
		'type' => 'color' );
	...
	// EDITOR
	$options[] = array(
		'name' => __('Editor', 'options_framework_theme'),
		'type' => 'heading' );
